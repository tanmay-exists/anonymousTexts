...
export default function SendMessage() {
  ...
  // Manual state management for suggestions (Replaces useCompletion)
  ...
  const fetchSuggestedMessages = async () => {
    ...
    try {
      // POST request to your updated API
  ...
  return (
    <div className="container mx-auto mt-10 p-10 bg-white rounded rounded-3xl border shadow-lg max-w-4xl">
            ...
            {suggestError ? (
              ...
              parseStringMessages(suggestedMessages).map((message, index) => (
                <Button
                  key={index}
                  variant="outline"
                  className="mb-2 whitespace-normal h-auto justify-start text-left"
